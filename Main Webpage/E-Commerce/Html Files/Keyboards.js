...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const products = [
        { id: 'akkoMU01AddToCart', name: "Akko MU01 JOL", price: "₱7299.00", quantityId: 'akkoMU01Qty' },
        { id: 'weikavLucky65V2AddToCart', name: "Weikav Lucky65 V2", price: "₱3300.00", quantityId: 'weikavLucky65V2Qty' },
        { id: 'aulaF75AddToCart', name: "Aula F75", price: "₱3000.00", quantityId: 'aulaF75Qty' },
        { id: 'aulaLEOBOGHi75AddToCart', name: "AULA LEOBOG Hi75", price: "₱2400.00", quantityId: 'aulaLEOBOGHi75Qty' },
        { id: 'womierSK65AddToCart', name: "WOMIER SK65", price: "₱6000.00", quantityId: 'womierSK65Qty' }
    ];
